...
// replace code GET list of liquor types from directory with this ...
...
// replace code GET contents of 'gin.json' file with this ...
  app.get('/liquor/gin', (req, res) => {
    promiseLiquor.get('gin')
      .then(gin => res.json(gin))
      .catch(err => console.log(err));
  });
...
// replace code POST file with this ...
  app.post('/liquor/tequila', (req, res) => {
    promiseLiquor.post('tequila')
      .then(tequila => res.sendFile(tequila))
      .catch(err => console.log(err));
  });
...
// replace code PUT file with this ...
  app.put('/liquor/tequila', (req, res) => {
    promiseLiquor.put('tequila')
      .then(tequila => res.sendFile(tequila))
      .catch(err => console.log(err));
  });
...
// replace code DELETE file 'whisky.json' with this ...
  app.delete('/liquor/whisky', (req, res) => {
    promiseLiquor.remove(whisky)
      .then(whisky => res.send('deleted whisky'))
      .catch(err => console.log(err));
  })
