...
function resHandler(res, message, statusCode = 200, encoding = 'text/plain', requestHeader = {}, pugFile) {
    var headerType = (requestHeader.hasOwnProperty('content-type')) ? requestHeader['content-type'] : null;
    res.setHeader('Content-Type', (headerType) ? headerType : encoding);
